...
export default async function AddProductPage(){ 
    ...
    return (
         <>         
            ...
            <div className="container flex-auto w-3/4 pl-96 pr-36 mt-16">
            ...
            <form action={createProduct}>
                ...
                <select className="w-full text-slate-700 p-1 rounded-md mt-2 mb-4 border border-slate-900" type="text" id="category" name="category">
                ...
                <select className="w-full text-slate-700 p-1 rounded-md mt-2 mb-4 border border-slate-900" type="text" id="brand" name="brand" required >
                ...
                <input className="w-full text-slate-700 p-1 rounded-md mt-2 mb-4 border border-slate-900" type="number" step="0.01" id="price" name="price" required />
            ...
            <div className="container flex-auto w-1/4 mt-16 px-16 text-xs">
                ...
                <input className="block w-full text-slate-700 p-1 rounded-md mt-2 mb-4 border border-slate-900" type="text" id="categoryName" name="categoryName" required />
                
                <label className="block w-full" htmlFor="Image">Upload Image</label>
                <input className="block w-full file:p-1 file:bg-gradient-to-r from-cyan-500 to-blue-500 file:text-white text-slate-700 p-1 rounded-md mt-2 mb-4 border border-slate-900" type="file" accept="image/png, image/jpeg" id="image" name="image" required />                
                ...
                <input className="block w-full text-slate-700 p-1 rounded-md mt-2 mb-4 border border-slate-900" type="text" id="brandName" name="brandName" required />
