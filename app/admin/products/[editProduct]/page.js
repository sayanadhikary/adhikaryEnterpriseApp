    ...
    return (
        ...
        <form>
          <label className="flex" htmlFor="Product Name">{product.name}</label>
            <input className="w-full p-1 rounded-md mt-2 mb-4 border border-slate-900" type="text" id="productName" name="productName" placeholder={product.name} required />
        ...
        <input className="w-full p-1 rounded-md mt-2 mb-4 border border-slate-900" type="text" id="productName" name="productName" required />
        <FormSubmit btnText={"Update"} />
        </form>
        <form>
