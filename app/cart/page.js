...
export default async function CartPage(){
  ...
  const productArr = allProduct.slice(0, 3); 
  const priceArr = productArr.map(prod=>{
    return +prod.price
  })
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <dl className="flex items-center justify-between gap-4">
                ...
                <dd className="text-base font-medium text-gray-900 dark:text-white">₹9</dd>
              </dl>
            </div>

            <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
              <dt className="text-base font-bold text-gray-900 dark:text-white">Total</dt>
              <dd className="text-base font-bold text-gray-900 dark:text-white">{totalPrice-10+99+9}</dd>
            </dl>
          </div>
